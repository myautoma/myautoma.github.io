    ...
    },
    {
        ...
        subsections: [
            ...
            },
            {
                ...
                id: 'itarsAction',
                classes: ['itarsAction'],
                content: '<img class="helpFactionImg" src="img/factions/itars.jpg" /><p class="bold">Faction Action:</p><ul><li><a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a> <span class="bold">x2</span></li></ul><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Taklons',
                id: 'taklonsAction',
                classes: ['taklonsAction'],
                content: '<img class="helpFactionImg" src="img/factions/taklons.jpg" /><p class="bold">Faction Action:</p><ul><li><a class="helpLink helpLink-buildMine" href="#">Build a Mine</a></li></ul><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: Shortest distance to one of your planets with an <a class="helpLink helpLink-automaRange" href="#">Automa Range</a> of 3</li><li><a class="helpLink helpLink-finalScoring" href="#">Final Scoring</a></li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><br /><p class="bold">Faction Action:</p><ul><li><a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a></li></ul><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Terrans',
                id: 'terransAction',
                classes: ['terransAction'],
                content: '<img class="helpFactionImg" src="img/factions/terrans.jpg" /><p class="bold">Faction Action:</p><ul><li>Advance Gaia Project Research Area</li></ul><p>Tiebreakers:</p><ol><li>None</li></ol><p class="bold">Faction Action:</p><ul><li><a class="helpLink helpLink-buildMine" href="#">Build a Mine</a></li></ul><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: Transdim Planet with an <a class="helpLink helpLink-automaRange" href="#">Automa Range</a> of 4</li><li><a class="helpLink helpLink-finalScoring" href="#">Final Scoring</a></li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Xenos',
                id: 'xenosAction',
                classes: ['xenosAction'],
                content: '<img class="helpFactionImg" src="img/factions/xenos.jpg" /><p class="bold">Faction Action:</p><ul><li><a class="helpLink helpLink-buildMine" href="#">Build a Mine</a></li></ul><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: <a class="helpLink helpLink-automaRange" href="#">Automa Range</a> of 2</li><li><a class="helpLink helpLink-finalScoring" href="#">Final Scoring</a></li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><br /><p class="bold">Faction Action:</p><ul><li><a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a></li></ul><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
        ]
    },
    {
