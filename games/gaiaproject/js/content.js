...
var helpContent = [
    ...
    },
    {
        ...
        content: '<p>Starting with the first player and continuing in clockwise order, place one mine on any one home planet (matching your color) of your choice. Then, starting with the last player and continuing in counterclockwise order, place your second mine on a different home planet.</p><p>Players do not charge power for mines their opponents place during setup. Remember to always take the leftmost mine on your faction board when placing a mine.</p><p>The Xenos place their third mine after all players have placed their second mine. The Ivits place their planetary institute last, after all mines have been placed (including the Xenos&rsquo; third mine).</p><img class="fullWidth" src="img/help/placeFirstStructure.jpg" /><p class="italic">By placing your first mines you reveal spaces on your faction board. This is important for your income.</p>'
    },
    {
        ...
        subsections: [
            {
                ...
                content: '<img class="finalScoringHelpImg" src="img/support/goal-0-1.png" /><p>The table below shows the tiebreakers added to the "Build a Mine" action by final scoring tiles.</p><p>To determine which final scoring tile to use for the tiebreaker, check the top of the support card for one of the icons shown to the right. Based on the icon shown, resolve the tiebreaker based on the bottom final scoring tile (left icon), top tile (middle icon), or no tile (right icon).</p><table class="endScoringTable"><tr><th class="endScoringTable-yla0">Final Scoring Tile</th><th class="endScoringTable-yla0">Final Scoring Tiebreaker</th></tr><tr><td class="endScoringTable-yla0">Most sectors <img src="img/endOfGameGoals/5.png" /></td><td class="endScoringTable-cly1"><span style="font-weight:bold">TIEBREAKER 3b</span>: Planets in a sector without Automa planets.</td></tr><tr><td class="endScoringTable-yla0">Most planet types <img src="img/endOfGameGoals/3.png" /></td><td class="endScoringTable-cly1"><span style="font-weight:bold">TIEBREAKER 3b:</span> Planets of a type the Automa has not colonized yet.</td></tr><tr><td class="endScoringTable-1wig">Most Gaia Planets <img src="img/endOfGameGoals/4.png" /></td><td class="endScoringTable-0lax"><span style="font-weight:bold">TIEBREAKER 3b:</span> Gaia or Transdim Planets.</td></tr></table>'
            },
            {
                name: 'Automa Range',
                id: 'automaRange',
        ...
        subsections: [
            {
                ...
                content: '<img class="helpMainActionImg" src="img/main/advanceHighestResearchArea.png" /><ol><li><span class="bold">Valid Options:</span> Any research area in which the Automa can advance or an advanced tech tile is available.</li><li><span class="bold">Tiebreaker:</span></li><ol type="a"><li>The highest research level the Automa has reached in any valid research area.</li><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered selection.</a></li></ol><li><span class="bold">Execute action:</span></li><ol type="a"><li>If the Automa is at level 4 in a research area with an advanced tech tile, return that tile to the box instead of advancing to level 5.</li><li>Otherwise, advance the Automa one level in the selected research area.</li></ol></ol><p>Note that the Automa does not need a federation token to take this action.</p>'
            },
            {
                name: 'Advance Random Research Area',
                id: 'advanceRandomResearchArea',
                classes: ['advanceRandomResearchArea'],
                content: '<img class="helpMainActionImg" src="img/main/advanceRandomResearchArea.png" /><ol><li><span class="bold">Valid Options:</span> Any research area in which the Automa can advance or an advanced tech tile is available.</li><li><span class="bold">Tiebreaker:</span> <a class="helpLink helpLink-numberedSelection" href="#">Numbered selection.</a></li><li><span class="bold">Execute action:</span></li><ol type="a"><li>If the Automa is at level 4 in the selected research area with an advanced tech tile, return that tile to the box instead of advancing to level 5.</li><li>Otherwise, advance the Automa one level in the selected research area..</li></ol></ol><p>Note that the Automa does not need a federation token to take this action.</p>'
            },
            {
                name: 'Build a Mine',
                id: 'buildMine',
                classes: ['buildMine'],
                content: '<img class="helpMainActionImg" src="img/main/buildMine.png" /><ol><p><a class="helpLink helpLink-buildMineExample" href="#">Click here to view an example of building a mine.</a></p><li><span class="bold">Condition:</span> The Automa has at least one mine in its supply.</li><li><span class="bold">Valid Options:</span> Any empty planet (including Transdim Planets) within the <a class="helpLink helpLink-automaRange" href="#">Automa\'s range</a> of a planet the Automa has colonized.</li><li><span class="bold">Tiebreaker:</span></li><ol type="a"><li>Faction action tiebreaker, if built by a faction action.</li><li>See the <a class="helpLink helpLink-finalScoring" href="#">final scoring tile tiebreaker table</a>, if applicable.</li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection.</a></li></ol><li><span class="bold">Execute action:</span></li><ol type="a"><li>Place one mine from the Automa\'s supply on the selected planet. Place a Gaia tile on the planet if it is a Transdim Planet (the Automa does not use Gaiaformers).</li><li>If the mine was placed on a planet not adjacent to an Automa structure, place a satellite on any non-planet space you choose next to the new mine. (The satellite matters only for the "Most Satellites" final scoring tile.)</li><ul><li>Remember that <span class="bold">you</span> can charge power when the Automa builds a mine just as you do when playing against a human opponent.</li></ul></ol></ol><p>If the "Build a Mine" action cannot be resolved because the condition is not met or there are no valid planets, take an <a class="helpLink helpLink-upgrade" href="#">Upgrade</a> action instead.</p>'
            },
            {
        ...
        subsections: [
            {
                ...
                content: '<img class="helpFactionImg" src="img/factions/firaks.jpg" /><p class="bold">Faction Action: <a class="helpLink helpLink-upgrade" href="#">Upgrade</a></p><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: When <span class="bold">upgrading</span>, the Automa can downgrade from a research lab to a trading station. This has priority over normal <span class="bold">upgrades</span></li><li>Closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Geodens',
                id: 'geodensAction',
                classes: ['geodensAction'],
                content: '<img class="helpFactionImg" src="img/factions/geodens.jpg" /><p class="bold">Faction Action: <a class="helpLink helpLink-advanceRandomResearchArea" href="#">Advance Random Research Area</a></p><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><br /><p class="bold">Faction Action: <a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a></p><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Hadsch Hallas',
            ...
            },
            {
                ...
                id: 'itarsAction',
                classes: ['itarsAction'],
                content: '<img class="helpFactionImg" src="img/factions/itars.jpg" /><p class="bold">Faction Action: <a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a> <span class="bold">x2</span></p><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Taklons',
                id: 'taklonsAction',
                classes: ['taklonsAction'],
                content: '<img class="helpFactionImg" src="img/factions/taklons.jpg" /><p class="bold">Faction Action: <a class="helpLink helpLink-buildMine" href="#">Build a Mine</a></p><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: Shortest distance to one of your planets with an <a class="helpLink helpLink-automaRange" href="#">Automa Range</a> of 3</li><li><a class="helpLink helpLink-finalScoring" href="#">Final Scoring</a></li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><br /><p class="bold">Faction Action: <a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a></p><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Terrans',
                id: 'terransAction',
                classes: ['terransAction'],
                content: '<img class="helpFactionImg" src="img/factions/terrans.jpg" /><p class="bold">Faction Action: Advance Gaia Project Research Area</p><p>Tiebreakers:</p><ol><li>None</li></ol><p class="bold">Faction Action: <a class="helpLink helpLink-buildMine" href="#">Build a Mine</a></p><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: Transdim Planet with an <a class="helpLink helpLink-automaRange" href="#">Automa Range</a> of 4</li><li><a class="helpLink helpLink-finalScoring" href="#">Final Scoring</a></li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><div class="clearDiv"></div>'
            },
            {
                name: 'Xenos',
                id: 'xenosAction',
                classes: ['xenosAction'],
                content: '<img class="helpFactionImg" src="img/factions/xenos.jpg" /><p class="bold">Faction Action: <a class="helpLink helpLink-buildMine" href="#">Build a Mine</a></p><p>Tiebreakers:</p><ol><li>Faction Tiebreaker: <a class="helpLink helpLink-automaRange" href="#">Automa Range</a> of 2</li><li><a class="helpLink helpLink-finalScoring" href="#">Final Scoring</a></li><li>Planet type requiring the fewest terraforming steps for the Automa\'s faction. For this purpose, Gaia Planets require 1 terraforming step and Transdim Planets require 2 steps.</li><li>Planet closest to any of <span class="bold">your</span> planets.</li><li><a class="helpLink helpLink-directionalSelection" href="#">Directional Selection</a></li></ol><br /><p class="bold">Faction Action: <a class="helpLink helpLink-powerQIC" href="#">Power/Q.I.C. Action</a></p><p>Tiebreakers:</p><ol><li><a class="helpLink helpLink-numberedSelection" href="#">Numbered Selection</a></li></ol><div class="clearDiv"></div>'
            },
        ]
    },
    {
